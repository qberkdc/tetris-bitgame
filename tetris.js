...
function drawMatrix(matrix, offset, isGhost = false) {
    matrix.forEach((row, y) => {
        row.forEach((value, x) => {
            if (value !== 0) {
                context.fillStyle = isGhost ? colors[value] + '88' : colors[value];
...
let dropInterval = 1000; // Başlangıçta düşme aralığını 1 saniye olarak ayarla
